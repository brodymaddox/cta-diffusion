...
def load_transformed_dataset(IMG_SIZE):
    ...
    data = cta_dataset.CTAngiographyNoConditionDataset(root_dir='/home/brody/Laboratory/cta-diffusion/experiments/acas/', csv='annotations.csv', transform=data_transform)
    return data
...
def load_transformed_conditional_dataset(IMG_SIZE, conditioning_columns=[]):
    ...
    data_transform = transforms.Compose(data_transforms)
    data = cta_dataset.CTAngiographyDataset(root_dir='/home/brody/Laboratory/cta-diffusion/experiments/acas/', csv='annotations.csv', transform=data_transform, conditioning=True, 
